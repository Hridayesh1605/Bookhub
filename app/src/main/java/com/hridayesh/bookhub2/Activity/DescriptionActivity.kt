...
import com.hridayesh.bookhub2.database.BookDatabase
import com.hridayesh.bookhub2.database.BookEntity
                    ...
                    btnAddToFav.setOnClickListener {
                        ...
                        if (!DBAsyncTask(
                            ...
                            if (result){
                                ...
                                btnAddToFav.text = "Add to favourites"
                                val noFavColor =
                                    ContextCompat.getColor(applicationContext, R.color.design_default_color_background)
                                btnAddToFav.setBackgroundColor(noFavColor)
                            } else {
                                Toast.makeText(
                                    this@DescriptionActivity,
